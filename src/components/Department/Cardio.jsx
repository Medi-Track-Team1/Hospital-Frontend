...
const Cardio = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-100 pt-28 px-4 sm:px-6 flex flex-col items-center">
      {/* Header */}
      <div className="relative overflow-hidden rounded-lg px-6 py-6 flex flex-col md:flex-row justify-between items-center w-full max-w-6xl mb-6 bg-gradient-to-r from-blue-200 via-blue-100 to-white shadow-md gap-4">
      ...
      <div className="flex flex-col lg:flex-row bg-blue-100 mt-6 p-4 sm:p-6 mb-10 w-full max-w-6xl items-center">
        <div className="lg:w-1/2 flex justify-center items-center mb-6 lg:mb-0 transition-transform duration-700 hover:scale-105">
          <img
            ...
            className="rounded-lg w-full max-w-[500px] h-auto max-h-[280px] sm:max-h-[320px] object-cover shadow-lg"
          />
        </div>
        <div className="lg:w-1/2 lg:pl-8 text-black space-y-4 text-sm sm:text-base">
      ...
      <div className="flex flex-wrap justify-center gap-6 w-full px-2 sm:px-0">
        {[
          {
            id: 101,
            name: "Dr. Boopathi",
          ...
          <div
            key={doc.id}
            className="bg-white p-4 rounded-xl shadow-md w-full max-w-xs sm:max-w-sm flex flex-col items-center animate-fade-in-up"
          >
