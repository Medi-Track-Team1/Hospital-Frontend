    ...
    <div className="min-h-screen bg-blue-100 pt-28 px-6 flex flex-col items-center relative">
      ...
      <div className="flex flex-col lg:flex-row bg-blue-100 mt-6 p-6 mb-10 w-full max-w-6xl items-center">
        ...
        <div className="lg:w-1/2 lg:pl-8 text-black space-y-4">
          ...
          <p>Our Eyecare department is committed to preserving and enhancing your vision through advanced diagnostic and treatment services.</p>
          <p>We treat a wide range of conditions including cataracts, glaucoma, diabetic retinopathy, and dry eye syndrome.</p>
          <p>Our ophthalmologists and optometrists use cutting-edge tools to ensure precise vision correction and routine eye health monitoring.</p>
          <p>We offer both medical and surgical solutions, as well as pediatric and elderly eye care.</p>
          <p>Clear vision is our priority—delivered with care, clarity, and commitment.</p>
        </div>
      </div>
        ...
        {doctors.map((doctor, index) => (
          ...
          >
            <div className="w-32 h-32 overflow-hidden rounded-full bg-white">
              <img src={doctor.image} alt={doctor.name} className="w-50 h-30 object-contain" />
            </div>
