    ...
    <div className="min-h-screen bg-blue-100 pt-28 px-4 sm:px-6 flex flex-col items-center">
      ...
      <div className="flex flex-col lg:flex-row bg-blue-100 mt-6 p-4 sm:p-6 mb-10 w-full max-w-6xl items-center">
        ...
        <div className="w-full lg:w-1/2 lg:pl-8 text-black space-y-4">
          ...
          <p className="animate-fade-in-up">
            We address a wide spectrum of liver-related conditions, including viral hepatitis, liver
            fibrosis, autoimmune liver disease, and hepatocellular carcinoma.
          </p>
          <p className="animate-fade-in-up">
            From early diagnosis to liver transplant evaluation, we ensure personalized treatment
            paths tailored to each patient’s health status.
          </p>
          <p className="animate-fade-in-up">
            The department is equipped with cutting-edge imaging, liver biopsy services, and
            multidisciplinary support to offer holistic care.
          </p>
          <p className="animate-fade-in-up">
            Our mission is to improve liver health outcomes with compassion, advanced science, and
            continuous support.
          </p>
        </div>
      </div>
