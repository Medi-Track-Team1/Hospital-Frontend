...
// Reusable fadeIn variant for staggered scroll animation
const fadeInUp = {
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-6">
          {[
            {
              emoji: "🥗",
              text: "Eat a heart-smart diet with leafy greens, fresh fruits, and whole grains. Nutrition is your first line of defense!",
            },
            {
              emoji: "🏃‍♀️",
              text: "Exercise daily for at least 30 minutes to strengthen your cardiovascular system and reduce stress.",
            },
            {
              emoji: "🧘‍♂️",
              text: "Practice yoga and deep breathing to manage anxiety and boost heart resilience.",
            },
            {
              emoji: "🩺",
              text: "Schedule regular heart checkups, especially if you have a family history or existing health conditions.",
            },
          ].map((tip, index) => (
            <motion.div
              key={index}
